...
public class ModCreativeTab {
    ...
    public static final RegistryObject<CreativeModeTab> CUSTOM_WEAPONRY_TAB = CREATIVE_MODE_TAB.register("wysmoreweapons_tab",
            () -> CreativeModeTab.builder().icon(() -> new ItemStack(ModItems.DIAMOND_RAPIER.get()))
                    .title(Component.literal("WY's Epic Weaponry"))
