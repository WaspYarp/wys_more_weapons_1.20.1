...
import net.waspyarp.wysmoreweapons.util.datagen.loot.WysGlobalLootModifiersProvider;
import net.waspyarp.wysmoreweapons.util.datagen.recipes.WysRecipeProvider;
import net.waspyarp.wysmoreweapons.util.datagen.tags.WysBlockTagsProvider;
import net.waspyarp.wysmoreweapons.util.datagen.tags.WysItemTagsProvider;
