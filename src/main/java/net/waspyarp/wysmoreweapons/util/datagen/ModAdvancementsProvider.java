...
public class ModAdvancementsProvider implements ForgeAdvancementProvider.AdvancementGenerator {
    ...
    public void generate(HolderLookup.Provider registries, Consumer<Advancement> saver, ExistingFileHelper existingFileHelper) {
        ...
        Advancement wysArmorsRoot = Advancement.Builder.advancement()
                .display(Items.BOOK, Component.translatable(id + "root_title"), Component.translatable( id + "root_description"), new ResourceLocation( "minecraft:textures/block/oak_planks.png"), FrameType.TASK, false, false, false)
        ...
        Advancement ancientCrown = Advancement.Builder.advancement().parent(wysArmorsRoot)
                ...
                .addCriterion("ancient_crown", InventoryChangeTrigger.TriggerInstance.hasItems(ModItems.ANCIENT_CROWN.get())).save(saver, path("obtain_ancient_crown"), existingFileHelper);
